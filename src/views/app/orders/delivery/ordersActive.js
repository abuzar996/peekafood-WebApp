...
import { Card, CardBody, CardFooter, Button, CustomInput } from "reactstrap";
...
class OrdersActive extends Component {
  ...
  render() {
    return (
      <div>
        {this.props.activeOrders.order_status !== "DISPATCHED" && this.props.activeOrders.order_status !== "DELIVERED" ?
          <Card>
            ...
            <CardBody>
              <div>
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  {this.props.activeOrders.delivery_address}
                </div>
                <div className="d-flex justify-content-between align-items-center">

                  <strong>Name: </strong>
                  {this.props.activeOrders.name}
                  <strong>Contact: </strong>
                  {this.props.activeOrders.contact_number}
                </div>
            ...
            <CardFooter>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <Button
                  color="primary"
                  disabled={
                    this.props.activeOrders.order_status === "DISPATCHED" ||
                ...
                <Button
                  ...
                  disabled={
                    this.props.activeOrders.order_status === "READY" ||
                      this.checkReady() || this.props.activeOrders.order_status === "DISPATCHED"
                      ? true
                      : false
                  }
                ...
                <Button
                  ...
                  onClick={() =>
                    this.props.orderPickedUp(this.props.activeOrders.id, "DISPATCHED")
                  }
                >
                  Dispatched
    </Button>
            ...
            <CardFooter>
              <div className="d-flex justify-content-between align-items-center">
                <Button
                  color="secondary"
                  disabled={
                    this.props.activeOrders.order_status === "DELIVERED" ? true : false
                  }
                  onClick={() =>
                    this.props.orderPickedUp(this.props.activeOrders.id, "DELIVERED")
                  }
                >
                  Delivered
</Button>
